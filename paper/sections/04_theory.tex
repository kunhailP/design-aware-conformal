...
two-sided and is absorbed into $\varepsilon_{K,B}$. (A1) is strong --- it
requires the design noise to share the latent curves' cross-threshold
correlation profile --- and the survey-scale guarantee does not rest on it:
where it is doubtful the selector abstains.
