...
The guard fixes one direction by construction: the finite-$K$-guarded scale
...
two-sided and is absorbed into $\varepsilon_{K,B}$. Some shape restriction is not removable (the
...
the second assume (A1)--(A3), under which the observed scores are
independent but not identically distributed and the latent scores are
i.i.d. Deploy Algorithm~\ref{alg:safe} with the
