...
rounds 1--8 weights-only; the sample-design-file merge changes no net or
...
form a certified core on $\ge2$. Membership is co-certification on two
separate $\alpha=0.10$ bands, not a $90\%$ statement that two items truly
declined (that would need a partial-conjunction bound). The core is
...
\caption{The thirteen-country certified core, by evidence strength (WVS
