...
primary-sampling-unit (PSU) / replicate-weight bootstrap can estimate. The
transport score of a country is its worst-case standardized deviation from the
transport center,
\[
...
and $\xi_c$ is the induced design contamination (a working approximation,
since $R$ is a supremum; the impossibility below is stated at the curve scale
...
except for the post-communist East, a quantified scope condition on transport
\emph{into} that bloc (Supplementary Material).
